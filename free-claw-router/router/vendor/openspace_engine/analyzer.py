...
from .shims.types import BaseTool
...
from .shims.prompts import SkillEnginePrompts
...
if TYPE_CHECKING:
    ...
    from .shims.types import ToolQualityManager
...
class ExecutionAnalyzer:
    ...
    async def _run_analysis_loop(
        ...
        """
        from .shims.types import RecordingManager
